...
const { getEventType } = require('./get_eventtype');
...
function runIteration(time, iterationsTotal, iterationsRemaining) {
  ...
  const eventType = getEventType(iterationsTotal - iterationsRemaining);
...
function getData(args) {
  ...
  const START_DATE = startDate.utc().valueOf();
